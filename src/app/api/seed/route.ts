...
export async function POST() {
  try {
    ...
    try { await db.$executeRaw('PRAGMA synchronous = OFF'); } catch(e) { console.log('PRAGMA sync off skipped:', e.message); }
    try { await db.$executeRaw('PRAGMA journal_mode = WAL'); } catch(e) { console.log('PRAGMA WAL skipped:', e.message); }
